...
Based on the results from the pie charts, it is evident that the candidate with e highest likelihood of winning the survey is Joe Bidden. In essence, the basis of the results is in terms of the previous 2016 results where given that Donald Trump had the highest poll votes and percentage of winning then he was the most likely candidate to win the elections. 
...
Github Link: https://github.com/Yunglilao/Projectone/blob/main/paper.Rmd
